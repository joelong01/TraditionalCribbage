...
namespace Facet.Combinatorics {
    /// <summary>
    /// Combinations defines a meta-collection, typically a hand of lists, of all possible 
    /// subsets of a particular size from the set of values.  This hand is enumerable and 
    ...
    /// </remarks>
    /// <typeparam name="T">The type of the values within the hand.</typeparam>
    public class Combinations<T> : IMetaCollection<T> {
        #region Constructors

        /// <summary>
        /// No default constructor, must provided a hand of values and size.
        /// </summary>
        ...
        /// <summary>
        /// Create a combination set from the provided hand of values.
        ...
        /// <summary>
        /// Gets an enumerator for collecting the hand of combinations.
        /// </summary>
        ...
        public class Enumerator : IEnumerator<IList<T>> {
            ...
            /// by creating a new hand of those items that have a true in the permutation parrellel array.
            /// </remarks>
            ...
            /// a hand of original values from the bool permutation provided.  
            ...
            /// </summary>
            /// <remarks>
            /// To compute the current hand of values, the underlying permutation object
            ...
            /// <summary>
            /// The current hand of values, this is lazy evaluated by the Current property.
            /// </summary>
            private List<T> myCurrentList;

            /// <summary>
            /// An enumertor of the parents hand of lexicographic orderings.
            /// </summary>
