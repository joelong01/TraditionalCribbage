...
namespace Facet.Combinatorics {
    /// <summary>
    /// Variations defines a meta-collection, typically a hand of lists, of all possible 
    /// ordered subsets of a particular size from the set of values.  
    /// This hand is enumerable and allows the scanning of all possible Variations using a simple 
    ...
    public class Variations<T> : IMetaCollection<T> {
        ...
        /// <summary>
        /// Create a variation set from the indicated hand of values.
        ...
        public class EnumeratorWithRepetition : IEnumerator<IList<T>> {
            ...
            /// <summary>
            /// Computes the current hand based on the internal hand index.
            /// </summary>
        ...
        public class EnumeratorWithoutRepetition : IEnumerator<IList<T>> {
            ...
            /// <summary>
            /// Creates a hand of original values from the int permutation provided.  
            ...
            /// </summary>
            /// <remarks>
            /// To compute the current hand of values, the element to use is determined by 
