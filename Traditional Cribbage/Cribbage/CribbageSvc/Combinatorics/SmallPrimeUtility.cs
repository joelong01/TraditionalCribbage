...
namespace Facet.Combinatorics {
    ...
    public class SmallPrimeUtility {
        ...
        /// Since this will only factor Int32 sized integers, a simple hand of factors is returned instead
        /// of the more scalable, but more difficult to consume, hand of primes and associated exponents.
        /// </summary>
        /// <param name="i">The number to factorize, must be positive.</param>
        /// <returns>A simple hand of factors.</returns>
        ...
        /// <summary>
        /// Given two integers expressed as a hand of prime factors, multiplies these numbers
        ...
        /// </summary>
        /// <param name="lhs">LocalLeft Hand Side argument, expressed as hand of prime factors.</param>
        /// <param name="rhs">Right Hand Side argument, expressed as hand of prime factors.</param>
        /// <returns>Product, expressed as hand of prime factors.</returns>
        ...
        /// <summary>
        /// Given two integers expressed as a hand of prime factors, divides these numbers
        ...
        /// </summary>
        /// <param name="numerator">Numerator argument, expressed as hand of prime factors.</param>
        /// <param name="denominator">Denominator argument, expressed as hand of prime factors.</param>
        /// <returns>Resultant, expressed as hand of prime factors.</returns>
        ...
        /// <summary>
        /// Given a hand of prime factors returns the long representation.
        /// </summary>
        /// <param name="value">Integer, expressed as hand of prime factors.</param>
