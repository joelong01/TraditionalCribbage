...
namespace Facet.Combinatorics {
    /// <summary>
    /// Permutations defines a meta-collection, typically a hand of lists, of all
    /// possible orderings of a set of values.  This hand is enumerable and allows
    ...
    public class Permutations<T> : IMetaCollection<T> {
        ...
        /// <summary>
        /// No default constructor, must at least provided a hand of values.
        /// </summary>
        ...
        /// <summary>
        /// Create a permutation set from the provided hand of values.  
        ...
        /// <summary>
        /// Gets an enumerator for collecting the hand of permutations.
        /// </summary>
        ...
        public class Enumerator : IEnumerator<IList<T>> {
            ...
            /// <summary>
            /// The hand of values that are current to the enumerator.
            /// </summary>
        ...
        /// <summary>
        /// A hand of T that represents the order of elements as originally provided, used for Reset.
        /// </summary>
        private List<T> myValues;
